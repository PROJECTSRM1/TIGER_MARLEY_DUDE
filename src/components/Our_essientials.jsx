...
const categories = [
  ...
  { id: 2, name: "T-shirts", image: require("../assets/categories/tshirts.jpg"), url: "" },
  ...
  { id: 5, name: "Full Sleeves", image: require("../assets/categories/fullsleeves.jpg"), url: "" },
  ...
  { id: 8, name: "T-shirt Dress", image: require("../assets/categories/tshirt_dress.jpg"), url: "" },
